    ...
    return (
      <Tag id={id} className={`group/heading relative scroll-mt-24 ${className}`} {...rest}>
        ...
        <button
          ...
          className="not-prose relative ml-2 inline-flex h-7 w-7 items-center justify-center rounded-md align-middle text-gold-deep opacity-0 transition-opacity hover:bg-gold/10 focus-visible:opacity-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gold-deep group-hover/heading:opacity-100 [@media(hover:none)]:opacity-60 data-[copied=true]:opacity-100 after:pointer-events-none after:absolute after:right-0 after:bottom-full after:mb-1.5 after:whitespace-nowrap after:rounded after:bg-ink after:px-1.5 after:py-0.5 after:font-sans after:text-[0.6875rem] after:font-semibold after:leading-none after:tracking-normal after:text-cream after:opacity-0 after:transition-opacity after:content-['Copied'] data-[copied=true]:after:opacity-100"
        >
          {copied ? (
