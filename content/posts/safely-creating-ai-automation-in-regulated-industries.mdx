...
<aside className="not-prose mt-2 mb-10 p-4 rounded-lg border border-gold/30 bg-cream-50 text-sm text-ink-soft">
  First published on <a href="https://www.linkedin.com/pulse/how-safely-create-meaningful-ai-automation-regulated-industries-luke-ja5of/" target="_blank" rel="noopener noreferrer" className="font-semibold text-gold-deep underline underline-offset-2 decoration-gold/60 hover:decoration-gold-deep">LinkedIn</a> on 10 November 2025. Republished here.
</aside>
...
<figure className="not-prose my-8">
  <MdxImage src="/posts/safely-creating-ai-automation-in-regulated-industries/the-struggle-is-real.png" alt="The Struggle is Real" className="w-full h-auto rounded-lg ring-1 ring-gold/10" />
  <figcaption className="mt-3 text-center text-sm text-ink-mute italic">The Struggle is Real</figcaption>
</figure>
...
<figure className="not-prose my-8">
  <MdxImage src="/posts/safely-creating-ai-automation-in-regulated-industries/apples-typical-customer-support-experience.png" alt="Apple’s typical customer support experience flow" className="w-full h-auto rounded-lg ring-1 ring-gold/10" />
  <figcaption className="mt-3 text-center text-sm text-ink-mute italic">Apple’s Typical Customer Support Experience</figcaption>
</figure>
...
<figure className="not-prose my-8">
  <MdxImage src="/posts/safely-creating-ai-automation-in-regulated-industries/success.png" alt="Success: adaptive, fair, transparent service" className="w-full h-auto rounded-lg ring-1 ring-gold/10" />
  <figcaption className="mt-3 text-center text-sm text-ink-mute italic">Success</figcaption>
</figure>
...
<figure className="not-prose my-8">
  <MdxImage src="/posts/safely-creating-ai-automation-in-regulated-industries/example-breakdown-of-capabilities.png" alt="Example breakdown of capabilities" className="w-full h-auto rounded-lg ring-1 ring-gold/10" />
  <figcaption className="mt-3 text-center text-sm text-ink-mute italic">Example Breakdown of Capabilities</figcaption>
</figure>
...
<figure className="not-prose my-8">
  <MdxImage src="/posts/safely-creating-ai-automation-in-regulated-industries/dynamic-path-components-boat-capabilities.png" alt="Dynamic Path components mapped to BOAT capabilities" className="w-full h-auto rounded-lg ring-1 ring-gold/10" />
  <figcaption className="mt-3 text-center text-sm text-ink-mute italic">Dynamic Path Components → BOAT Capabilities</figcaption>
</figure>
...
<figure className="not-prose my-8">
  <MdxImage src="/posts/safely-creating-ai-automation-in-regulated-industries/a-possible-ai-powered-v2-of-apples-customer-support.png" alt="A possible AI-powered v2 of Apple’s customer support, showcasing a Dynamic Paths approach" className="w-full h-auto rounded-lg ring-1 ring-gold/10" />
  <figcaption className="mt-3 text-center text-sm text-ink-mute italic">A Possible AI-Powered V2 of Apple’s Customer Support, showcasing a "Dynamic Paths" Approach</figcaption>
</figure>
