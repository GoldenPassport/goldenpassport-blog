...
<Figure
  src="/posts/gdpr-restricts-fully-automated-decision-flows/gdpr-a22.webp"
...
Article 22: Automated individual decision-making, including profiling. Source: [EUR-Lex](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32016R0679#art_22).
...
<Figure
  ...
  caption="Anti-pattern 1: the decision and its consequence are part of the same automated path."
  download="/posts/gdpr-restricts-fully-automated-decision-flows/decision-and-consequence.bpmn"
...
<Figure
  ...
  caption="Anti-pattern 2: a user task exists, but the person cannot provide meaningful review."
  download="/posts/gdpr-restricts-fully-automated-decision-flows/rubber-stamp-review.bpmn"
  downloadLabel="Download BPMN"
/>
...
<Figure
  ...
  caption="Anti-pattern 3: the process closes the case without giving the individual a route forward or a clear, fair explanation."
  download="/posts/gdpr-restricts-fully-automated-decision-flows/dead-end-outcome.bpmn"
  downloadLabel="Download BPMN"
/>
...
<Figure
  ...
  caption="Example pattern: explainable AI and business rules provide complementary evidence, a person makes the decision independently, and the applicant has a clear route forward."
  download="/posts/gdpr-restricts-fully-automated-decision-flows/meaningful-human-decision.bpmn"
  downloadLabel="Download BPMN"
/>
